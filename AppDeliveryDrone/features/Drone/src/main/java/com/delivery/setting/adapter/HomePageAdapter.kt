...
import com.delivery.core.adapter.OnItemClickListener
import com.delivery.core.utils.loadImage
import com.delivery.setting.R
import com.delivery.setting.databinding.ItemAlbumLayoutBinding
import com.delivery.setting.databinding.ItemHomeSlideLayoutBinding
import com.delivery.setting.databinding.ItemTitleHomeLayoutBinding
import com.delivery.setting.model.HomePageItem
import timber.log.Timber

/**
 * Created by TrongVQ on 2022-03-17.
 */
class HomePageAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        return when (viewType) {
            R.layout.item_home_slide_layout ->
                HomeSlideViewHolder(
            ...
            R.layout.item_title_home_layout ->
                HomeTitleHolder(
...
class HomePageDiffUtil : DiffUtil.ItemCallback<HomePageItem>() {
    override fun areItemsTheSame(
        oldItem: HomePageItem,
        newItem: HomePageItem,
    ): Boolean {
...
fun compareListSlide(
    oldItem: HomePageItem.SlideHome,
    newItem: HomePageItem.SlideHome,
): Boolean {
