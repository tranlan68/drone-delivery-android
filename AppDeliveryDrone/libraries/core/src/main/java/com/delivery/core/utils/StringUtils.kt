...
import com.delivery.core.utils.EdtState.EDT_EMPTY
import com.delivery.core.utils.EdtState.EDT_LENGTH_INVALID
import com.delivery.core.utils.EdtState.EDT_NOT_HALFWIDTH_OR_DIGIT
import com.delivery.core.utils.EdtState.SUCCESS
...
//        }
    ...
    fun String.isValidPhoneNumber(): Boolean {
        val matcher = Pattern.compile("(0[3|5|7|8|9])+([0-9]{8})\\b").matcher(this)
        return matcher.matches()
    }

    fun TextView.setTextRequired(string: String) {
        val span = SpannableString(string)
        span.setSpan(
            ForegroundColorSpan(ContextCompat.getColor(context, R.color.color_EC1C4A)),
            string.length - 1,
            string.length,
