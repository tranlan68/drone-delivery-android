...
class AppPreferences @Inject constructor(
    ...
    private object PreferencesKeys {
        ...
        val PREF_PARAM_SELECTED_LOCKER_ID = stringPreferencesKey("PREF_PARAM_SELECTED_LOCKER_ID")
    }
    ...
    override fun getSelectedLockerId(): Flow<String?> = getValue(PreferencesKeys.PREF_PARAM_SELECTED_LOCKER_ID)

    override suspend fun setSelectedLockerId(lockerId: String) {
        putValue(PreferencesKeys.PREF_PARAM_SELECTED_LOCKER_ID, lockerId)
    }
