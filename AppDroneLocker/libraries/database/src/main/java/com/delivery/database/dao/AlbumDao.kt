...
interface AlbumDao {
    ...
    @Query("SELECT * FROM albums WHERE title LIKE '%' || :query || '%' OR artist_name LIKE '%' || :query || '%' ORDER BY title ASC LIMIT :limit")
    fun searchAlbums(query: String, limit: Int = 50): Flow<List<AlbumEntity>>
